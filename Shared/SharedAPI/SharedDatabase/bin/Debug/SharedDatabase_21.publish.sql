...
GO
PRINT N'Dropping DF__tmp_ms_xx__Conce__04AFB25B...';


GO
ALTER TABLE [dbo].[CollaborationSpace] DROP CONSTRAINT [DF__tmp_ms_xx__Conce__04AFB25B];
...
GO
ALTER TABLE [dbo].[CollaborationSpace] ALTER COLUMN [ConceptId] INT NULL;
