...
GO
PRINT N'Dropping DF__SongComme__Ratin__29AC2CE0...';


GO
ALTER TABLE [dbo].[SongComment] DROP CONSTRAINT [DF__SongComme__Ratin__29AC2CE0];


GO
PRINT N'Dropping DF__SongComme__IsApp__2AA05119...';


GO
ALTER TABLE [dbo].[SongComment] DROP CONSTRAINT [DF__SongComme__IsApp__2AA05119];


GO
PRINT N'Dropping DF__SongComme__IsAno__2B947552...';


GO
ALTER TABLE [dbo].[SongComment] DROP CONSTRAINT [DF__SongComme__IsAno__2B947552];


GO
PRINT N'Dropping FK_SongComment_Song...';


GO
ALTER TABLE [dbo].[SongComment] DROP CONSTRAINT [FK_SongComment_Song];


GO
PRINT N'Starting rebuilding table [dbo].[SongComment]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_SongComment] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[SongComment])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_SongComment] ON;
        INSERT INTO [dbo].[tmp_ms_xx_SongComment] ([SongCommentId], [SongId], [Comment], [Rating], [CreateDate], [IsApproved], [IsAnonymous], [Name], [EmailAddress])
        SELECT   [SongCommentId],
                 [SongId],
                 [Comment],
                 [Rating],
                 [CreateDate],
                 ...
                 [EmailAddress]
        FROM     [dbo].[SongComment]
        ORDER BY [SongCommentId] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_SongComment] OFF;
    END

DROP TABLE [dbo].[SongComment];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_SongComment]', N'SongComment';
...
GO
PRINT N'Creating FK_SongComment_Song...';


GO
ALTER TABLE [dbo].[SongComment] WITH NOCHECK
    ADD CONSTRAINT [FK_SongComment_Song] FOREIGN KEY ([SongId]) REFERENCES [dbo].[Song] ([SongId]);
...
GO
ALTER TABLE [dbo].[SongComment] WITH CHECK CHECK CONSTRAINT [FK_SongComment_Song];
